...
class AgriculturePointage(models.Model):
    ...
    magnesium = fields.Float(string="Magnésium (kg)", required=False, )
    calcium = fields.Float(string="Calcium (kg)", required=False, )
    dithane = fields.Float(string="Dithane (kg)", required=False, )
    acide_amine = fields.Float(string="Acide aminé (L)", required=False, )
